...
import asyncio
from source.data.server_data import ip_addresses
...
class LogWindow(InteractiveWindow):
    ...
    def __init__(self, game_instance):
        ...
        self.w = 1000
        self.h = 600
        self.img = pygame.image.load('source/assets/log_window.png')
        ...
        self.ui_elements = [
            ...
            ButtonObject(self.x + self.w - 130, self.y + 120, 40, 40, 'source/assets/green.png',
                         object_id='serv_button_START'),
            ButtonObject(self.x + self.w - 130, self.y + 180, 40, 40, 'source/assets/red.png',
