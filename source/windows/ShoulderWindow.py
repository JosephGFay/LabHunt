...
from source.windows.endWindow import EndWindow
import pygame
import sys
from pygame.locals import QUIT
import source.Joetilities.utilities
from source.data.npc_activites import activities, articles
import random
...
class ShoulderWindow(InteractiveWindow):
    ...
    def __init__(self, student, detected) -> None:
        ...
        self.ui_elements = [
            ...
            # Profile
            UIObject(self.x + 40, self.row_0, 100, 120, 'source/assets/npc_top.png'),
            # Event Picture
            UIObject(self.x + self.w - 390, self.row_0, 350, 480, 'source/assets/shoulder_view.png'),

            UIInteractableObject(self.x + 190, self.row_0 + 60, 200, 50, 'source/assets/expose_hacker.png', object_id='accuse_button')
        ]
