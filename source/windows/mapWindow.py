...
from source.windows.ui_ButtonObject import ButtonObject
...
class MapWindow(InteractiveWindow):
    ...
    def __init__(self, game_instance):
        ...
        self.w = 1000
        self.h = 600
        self.img = pygame.image.load('source/assets/map_window.png')
        ...
        self.ui_elements = [
            ...
            ButtonObject(self.col_0, self.row_0, 80, 80, 'source/assets/table_blue.png', object_id='top_left'),

            ButtonObject(self.col_0, self.row_3, 80, 80, 'source/assets/table_red.png', object_id='bottom_left'),

            ButtonObject(self.col_1, self.row_2, 80, 80, 'source/assets/table_red.png', object_id='middle'),

            ButtonObject(self.col_1, self.row_4, 80, 80, 'source/assets/table_red.png', object_id='bottom_middle'),

            UIObject(self.col_2, self.row_2, 80, 80, 'source/assets/server.png'),

            ButtonObject(self.col_2, self.row_0, 80, 80, 'source/assets/table_red.png', object_id='top_right'),

            ButtonObject(self.col_2, self.row_4, 80, 80, 'source/assets/table_blue.png', object_id='bottom_right'),
        ]
    ...
    def display_info(self, table):
        ...
        self.info_ui = [
            # Monitor Images
            UIObject(self.col_3, row_0, 64, 64, 'source/assets/monitor.png'),
            UIObject(self.col_3, row_1, 64, 64, 'source/assets/monitor.png'),
            UIObject(self.col_3, row_2, 64, 64, 'source/assets/monitor.png'),
            UIObject(self.col_3, row_3, 64, 64, 'source/assets/monitor.png'),
    ...
    def display(self) -> None:
        ...
        while True:
            ...
            for index, selection in enumerate(self.menu_options):
                if source.Joetilities.utilities.get_mouse_collision(mouse_pos, selection):
