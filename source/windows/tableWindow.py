from source.windows.ShoulderWindow import ShoulderWindow
...
class TableWindow(InteractiveWindow):
    ...
    def __init__(self, table) -> None:
        ...
        self.ui_objects = [
            ...
            # Player cards
            UIInteractableObject(self.col_0, self.row_1, 100, 120, 'source/assets/npc_top.png'),
            UIInteractableObject(self.col_1, self.row_1, 100, 120, 'source/assets/npc_top.png'),
            UIInteractableObject(self.col_2, self.row_1, 100, 120, 'source/assets/npc_top.png'),
            UIInteractableObject(self.col_3, self.row_1, 100, 120, 'source/assets/npc_top.png'),
            # Names
