...
from source.windows.logWindow import LogWindow
from source.windows.mapWindow import MapWindow
...
class ServerWindow(InteractiveWindow):
    ...
    def __init__(self, game_instance):
        ...
        self.ui_elements = [
            ...
            ButtonObject(self.col_1 + 50, self.row_1 - 8, 280, 40, 'source/assets/green.png', object_id='logs'),

            TextObject(None, 'View Map', self.col_1 + 50 + 80, self.row_2 + 10, 24),

            ButtonObject(self.col_1 + 50, self.row_2, 280, 40, 'source/assets/green.png', object_id='map'),
        ]
